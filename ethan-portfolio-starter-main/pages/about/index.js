    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <h2 className="h2">
            Captivating <span className="text-accent font-bold">Stories</span>{" "}
            birth magnificent designs.{" "}
          </h2>
          <p className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 sm::mb-5 px-2 xl:px-0">
        ...
        {/* info */}
        <div className="flex flex-col w-full xl:max-w-[48%] h-[480px] xl:mt-20 sm:mt-0">
          ...
          <div className=" py-2 xl:py-6 flex flex-col gap-y-2 xl:gay-y-2 items-center xl:items-start">
